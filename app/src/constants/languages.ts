...
export interface Strings {
  ...
  workNearHome: string;
  workElsewhere: string;
  whereQuestion: string;
  locationSaved: string; // must contain "{place}"
  eduBelow10th: string;
  edu10th: string;
  edu12th: string;
  eduIti: string;
  ...
  otpSentTo: string; // must contain "{phone}"
  changeNumber: string;
...
const hi: Strings = {
  ...
  agentThinking: 'जवाब तैयार हो रहा है…',
  agentName: 'सक्षम',
  agentTapToTalk: 'सक्षम से बात करें',
  agentHint: 'अपना सवाल बोलिए, सक्षम जवाब देगा',
  agentFallbackReply: 'मैंने आपकी बात समझ ली।',
  clearAgent: 'साफ करें',
  viewResults: 'परिणाम देखें',
  transcriptionError: 'आवाज़ समझ नहीं आई',
  ...
  nsqfMatch: 'एन एस क्यू एफ योग्यता',
  matchLabel: 'मिलान',
  ...
  noMatch: 'हुनर साफ़ समझ नहीं आया। कृपया थोड़ा और विस्तार से बताइए।',
  call: 'कॉल करें',
  apply: 'आवेदन करें',
  applied: 'आवेदन हो गया',
  applying: 'भेजा जा रहा है…',
  loginToApply: 'पहले लॉग इन करें',
  loginToApplyBody: 'आवेदन करने के लिए खाता ज़रूरी है, ताकि नियोक्ता आपसे संपर्क कर सके।',
  ...
  programsTitle: 'पी एम अजय प्रशिक्षण',
  ...
  optionJobs: 'काम या रोज़गार ढूँढना',
  optionTraining: 'ट्रेनिंग करना चाहता हूँ',
  optionCertificate: 'मेरे हुनर का प्रमाणपत्र चाहिए',
  optionGuidance: 'मुझे समझ नहीं आ रहा, सलाह चाहिए',
  ...
  livelihoodMap: 'आपका आजीविका नक्शा',
  mapJobs: 'नौकरियाँ',
  mapTraining: 'ट्रेनिंग',
  mapMatches: 'मिलीं',
  mapForYou: 'आपके लिए',
  yourSkills: 'आपके हुनर',
  completeProfile: 'प्रोफ़ाइल पूरी करें',
  recommendedPath: 'सुझाया गया रास्ता',
  viewPathway: 'रास्ता देखें',
  potentialRoles: 'संभावित भूमिकाएँ',
  noSkillsYet: 'अपना हुनर बताने के लिए बोलिए',
  qualLapsed: 'प्रमाणन पुराना',
  ...
  onboardIntroTitle: 'हम आपको बेहतर समझना चाहते हैं',
  onboardIntroBody: 'बस 3 छोटे सवाल। इससे हम आपके लिए सही प्रशिक्षण और योजनाएँ ढूँढ पाएँगे।',
  ...
  skillDetailQuestion: 'इस काम के बारे में थोड़ा और बताइए। जैसे आप किस कक्षा, उम्र, विषय, चीज़ या तरीके से काम करते हैं?',
  ...
  workElsewhere: 'कहीं और',
  whereQuestion: 'कौन सी जगह?',
  locationSaved: 'जगह सेव हो गई है: {place}',
  ...
  invalidOtp: 'कृपया सही 4 अंकों का कोड डालें',
  passwordMismatch: 'दोनों पासवर्ड मेल नहीं खाते',
  otpLengthError: '4 अंकों का कोड डालें',
  ...
  whatsappTitle: 'सक्षम ए आई अब व्हाट्सएप पर',
  ...
  voiceProfileGreeting: 'नमस्ते! मैं सक्षम हूँ। कृपया अपना नाम बताइए।',
  voiceProfileGreetingNamed: 'नमस्ते, {name}! मैं सक्षम हूँ।',
...
const en: Strings = {
  ...
  examples: [
    'I teach children',
    'I repair mobile phones',
    'I do accounting and Tally',
    'I edit videos',
  ],
  yourSkill: 'You said',
  ...
  applied: 'Applied',
  applying: 'Sending…',
  loginToApply: 'Please log in first',
  loginToApplyBody: 'You need an account to apply, so the employer can contact you back.',
  ...
  optionCertificate: 'A certificate for the skill I already have',
  optionGuidance: "I'm not sure — I need guidance",
  ...
  livelihoodMap: 'Your livelihood map',
  mapJobs: 'Jobs',
  mapTraining: 'Training',
  mapMatches: 'matches',
  mapForYou: 'for you',
  ...
  noSkillsYet: 'Speak to map your skills',
  qualLapsed: 'Certification lapsed',
  ...
  workElsewhere: 'Somewhere else',
  whereQuestion: 'Which place?',
  locationSaved: 'Location saved: {place}',
  ...
  otpLengthError: 'Enter the 4-digit code',
...
const bn: Strings = {
  ...
  applying: 'পাঠানো হচ্ছে…',
  loginToApply: 'আগে লগ ইন করুন',
  loginToApplyBody: 'আবেদন করতে অ্যাকাউন্ট লাগবে, যাতে নিয়োগকর্তা আপনার সাথে যোগাযোগ করতে পারেন।',
  ...
  optionCertificate: 'আমার বর্তমান দক্ষতার সার্টিফিকেট চাই',
  optionGuidance: 'বুঝতে পারছি না, পরামর্শ চাই',
  ...
  livelihoodMap: 'আপনার জীবিকার মানচিত্র',
  mapJobs: 'চাকরি',
  mapTraining: 'প্রশিক্ষণ',
  mapMatches: 'টি মিল',
  mapForYou: 'আপনার জন্য',
  yourSkills: 'আপনার দক্ষতা',
  completeProfile: 'প্রোফাইল সম্পূর্ণ করুন',
  recommendedPath: 'প্রস্তাবিত পথ',
  viewPathway: 'পথ দেখুন',
  potentialRoles: 'সম্ভাব্য ভূমিকা',
  noSkillsYet: 'দক্ষতা জানাতে বলুন',
  qualLapsed: 'সার্টিফিকেশন মেয়াদোত্তীর্ণ',
  ...
  workElsewhere: 'অন্য কোথাও',
  whereQuestion: 'কোন জায়গা?',
  locationSaved: 'জায়গা সংরক্ষিত: {place}',
  ...
  otpLengthError: '৪ সংখ্যার কোড দিন',
  otpSentTo: '{phone} নম্বরে কোড পাঠানো হয়েছে',
...
const ta: Strings = {
  ...
  applying: 'அனுப்புகிறது…',
  loginToApply: 'முதலில் உள்நுழையவும்',
  loginToApplyBody: 'விண்ணப்பிக்க கணக்கு தேவை, முதலாளி உங்களைத் தொடர்பு கொள்ள.',
  ...
  optionCertificate: 'என் தற்போதைய திறனுக்கு சான்றிதழ் வேண்டும்',
  optionGuidance: 'புரியவில்லை, ஆலோசனை வேண்டும்',
  ...
  livelihoodMap: 'உங்கள் வாழ்வாதார வரைபடம்',
  mapJobs: 'வேலைகள்',
  mapTraining: 'பயிற்சி',
  mapMatches: 'பொருத்தங்கள்',
  mapForYou: 'உங்களுக்கு',
  yourSkills: 'உங்கள் திறன்கள்',
  completeProfile: 'சுயவிவரத்தை நிறைவு செய்க',
  recommendedPath: 'பரிந்துரைக்கப்பட்ட பாதை',
  viewPathway: 'பாதையைப் பார்க்க',
  potentialRoles: 'சாத்தியமான பணிகள்',
  noSkillsYet: 'திறனைக் கூற பேசுங்கள்',
  qualLapsed: 'சான்றிதழ் காலாவதி',
  ...
  workElsewhere: 'வேறு இடத்தில்',
  whereQuestion: 'எந்த இடம்?',
  locationSaved: 'இடம் சேமிக்கப்பட்டது: {place}',
  ...
  otpLengthError: '4 இலக்க குறியீட்டை உள்ளிடவும்',
...
const te: Strings = {
  ...
  applying: 'పంపుతోంది…',
  loginToApply: 'ముందు లాగిన్ చేయండి',
  loginToApplyBody: 'దరఖాస్తు చేయడానికి ఖాతా అవసరం, యజమాని మిమ్మల్ని సంప్రదించడానికి.',
  ...
  optionCertificate: 'నా ప్రస్తుత నైపుణ్యానికి సర్టిఫికేట్ కావాలి',
  optionGuidance: 'అర్థం కావడం లేదు, సలహా కావాలి',
  ...
  jobPositions: 'ఖాళీలు',
  jobPerMonth: 'నెలకు',
  livelihoodMap: 'మీ జీవనోపాధి పటం',
  mapJobs: 'ఉద్యోగాలు',
  mapTraining: 'శిక్షణ',
  mapMatches: 'సరిపోలికలు',
  mapForYou: 'మీ కోసం',
  yourSkills: 'మీ నైపుణ్యాలు',
  completeProfile: 'ప్రొఫైల్ పూర్తి చేయండి',
  recommendedPath: 'సూచించిన మార్గం',
  viewPathway: 'మార్గం చూడండి',
  potentialRoles: 'సాధ్యమైన పాత్రలు',
  noSkillsYet: 'నైపుణ్యం చెప్పడానికి మాట్లాడండి',
  qualLapsed: 'సర్టిఫికేషన్ గడువు ముగిసింది',
  ...
  workElsewhere: 'వేరే చోట',
  whereQuestion: 'ఏ ప్రదేశం?',
  locationSaved: 'ప్రదేశం సేవ్ అయింది: {place}',
  ...
  otpLengthError: '4 అంకెల కోడ్ నమోదు చేయండి',
  otpSentTo: '{phone}కి కోడ్ పంపబడింది',
...
const mr: Strings = {
  ...
  applied: 'अर्ज केला',
  applying: 'पाठवत आहे…',
  loginToApply: 'आधी लॉग इन करा',
  loginToApplyBody: 'अर्ज करण्यासाठी खाते आवश्यक आहे, जेणेकरून नियोक्ता तुमच्याशी संपर्क साधू शकेल.',
  ...
  optionCertificate: 'माझ्या सध्याच्या कौशल्याचे प्रमाणपत्र हवे',
  optionGuidance: 'मला समजत नाही, मार्गदर्शन हवे',
  ...
  jobPositions: 'जागा',
  jobPerMonth: 'दरमहा',
  livelihoodMap: 'तुमचा उपजीविका नकाशा',
  mapJobs: 'नोकऱ्या',
  mapTraining: 'प्रशिक्षण',
  mapMatches: 'जुळणी',
  mapForYou: 'तुमच्यासाठी',
  yourSkills: 'तुमची कौशल्ये',
  completeProfile: 'प्रोफाइल पूर्ण करा',
  recommendedPath: 'सुचवलेला मार्ग',
  viewPathway: 'मार्ग पहा',
  potentialRoles: 'संभाव्य भूमिका',
  noSkillsYet: 'कौशल्य सांगण्यासाठी बोला',
  qualLapsed: 'प्रमाणपत्र कालबाह्य',
  ...
  workNearHome: 'घराजवळ',
  workElsewhere: 'दुसरीकडे',
  whereQuestion: 'कोणती जागा?',
  locationSaved: 'जागा सेव्ह झाली: {place}',
  ...
  otpLengthError: '4 अंकी कोड टाका',
...
const kn: Strings = {
  ...
  applying: 'ಕಳುಹಿಸಲಾಗುತ್ತಿದೆ…',
  loginToApply: 'ಮೊದಲು ಲಾಗಿನ್ ಮಾಡಿ',
  loginToApplyBody: 'ಅರ್ಜಿ ಸಲ್ಲಿಸಲು ಖಾತೆ ಬೇಕು, ಉದ್ಯೋಗದಾತರು ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಲು.',
  ...
  optionCertificate: 'ನನ್ನ ಈಗಿನ ಕೌಶಲ್ಯಕ್ಕೆ ಪ್ರಮಾಣಪತ್ರ ಬೇಕು',
  optionGuidance: 'ಅರ್ಥವಾಗುತ್ತಿಲ್ಲ, ಮಾರ್ಗದರ್ಶನ ಬೇಕು',
  ...
  livelihoodMap: 'ನಿಮ್ಮ ಜೀವನೋಪಾಯ ನಕ್ಷೆ',
  mapJobs: 'ಉದ್ಯೋಗಗಳು',
  mapTraining: 'ತರಬೇತಿ',
  mapMatches: 'ಹೊಂದಾಣಿಕೆಗಳು',
  mapForYou: 'ನಿಮಗಾಗಿ',
  yourSkills: 'ನಿಮ್ಮ ಕೌಶಲ್ಯಗಳು',
  completeProfile: 'ಪ್ರೊಫೈಲ್ ಪೂರ್ಣಗೊಳಿಸಿ',
  recommendedPath: 'ಶಿಫಾರಸು ಮಾಡಿದ ಮಾರ್ಗ',
  viewPathway: 'ಮಾರ್ಗ ನೋಡಿ',
  potentialRoles: 'ಸಂಭಾವ್ಯ ಪಾತ್ರಗಳು',
  noSkillsYet: 'ಕೌಶಲ್ಯ ಹೇಳಲು ಮಾತನಾಡಿ',
  qualLapsed: 'ಪ್ರಮಾಣೀಕರಣ ಅವಧಿ ಮುಗಿದಿದೆ',
  ...
  workElsewhere: 'ಬೇರೆಡೆ',
  whereQuestion: 'ಯಾವ ಸ್ಥಳ?',
  locationSaved: 'ಸ್ಥಳ ಉಳಿಸಲಾಗಿದೆ: {place}',
  ...
  otpLengthError: '4 ಅಂಕಿಯ ಕೋಡ್ ನಮೂದಿಸಿ',
...
const gu: Strings = {
  ...
  apply: 'અરજી કરો',
  applied: 'અરજી કરી',
  applying: 'મોકલી રહ્યા છીએ…',
  loginToApply: 'પહેલા લોગ ઇન કરો',
  loginToApplyBody: 'અરજી કરવા ખાતું જરૂરી છે, જેથી નોકરીદાતા તમારો સંપર્ક કરી શકે.',
  ...
  optionCertificate: 'મારા હાલના કૌશલ્યનું પ્રમાણપત્ર જોઈએ છે',
  optionGuidance: 'મને સમજાતું નથી, માર્ગદર્શન જોઈએ છે',
  ...
  livelihoodMap: 'તમારો આજીવિકા નકશો',
  mapJobs: 'નોકરીઓ',
  mapTraining: 'તાલીમ',
  mapMatches: 'મેળ',
  mapForYou: 'તમારા માટે',
  yourSkills: 'તમારી કુશળતા',
  completeProfile: 'પ્રોફાઇલ પૂર્ણ કરો',
  recommendedPath: 'સૂચવેલ માર્ગ',
  viewPathway: 'માર્ગ જુઓ',
  potentialRoles: 'સંભવિત ભૂમિકાઓ',
  noSkillsYet: 'કુશળતા જણાવવા બોલો',
  qualLapsed: 'પ્રમાણપત્ર સમાપ્ત',
  ...
  workElsewhere: 'બીજે ક્યાંક',
  whereQuestion: 'કઈ જગ્યા?',
  locationSaved: 'સ્થળ સાચવ્યું: {place}',
  ...
  otpLengthError: '4 અંકનો કોડ દાખલ કરો',
  otpSentTo: '{phone} પર કોડ મોકલ્યો',
...
const pa: Strings = {
  ...
  apply: 'ਅਰਜ਼ੀ ਦਿਓ',
  applied: 'ਅਰਜ਼ੀ ਦਿੱਤੀ',
  applying: 'ਭੇਜ ਰਹੇ ਹਾਂ…',
  loginToApply: 'ਪਹਿਲਾਂ ਲੌਗ ਇਨ ਕਰੋ',
  loginToApplyBody: 'ਅਰਜ਼ੀ ਦੇਣ ਲਈ ਖਾਤਾ ਚਾਹੀਦਾ ਹੈ, ਤਾਂ ਜੋ ਮਾਲਕ ਤੁਹਾਡੇ ਨਾਲ ਸੰਪਰਕ ਕਰ ਸਕੇ।',
  ...
  optionCertificate: 'ਮੈਨੂੰ ਆਪਣੇ ਮੌਜੂਦਾ ਹੁਨਰ ਦਾ ਸਰਟੀਫਿਕੇਟ ਚਾਹੀਦਾ ਹੈ',
  optionGuidance: 'ਮੈਨੂੰ ਸਮਝ ਨਹੀਂ ਆ ਰਿਹਾ, ਸਲਾਹ ਚਾਹੀਦੀ ਹੈ',
  ...
  livelihoodMap: 'ਤੁਹਾਡਾ ਰੋਜ਼ੀ-ਰੋਟੀ ਨਕਸ਼ਾ',
  mapJobs: 'ਨੌਕਰੀਆਂ',
  mapTraining: 'ਸਿਖਲਾਈ',
  mapMatches: 'ਮੇਲ',
  mapForYou: 'ਤੁਹਾਡੇ ਲਈ',
  ...
  recommendedPath: 'ਸੁਝਾਇਆ ਰਸਤਾ',
  viewPathway: 'ਰਸਤਾ ਵੇਖੋ',
  potentialRoles: 'ਸੰਭਾਵੀ ਭੂਮਿਕਾਵਾਂ',
  noSkillsYet: 'ਹੁਨਰ ਦੱਸਣ ਲਈ ਬੋਲੋ',
  qualLapsed: 'ਸਰਟੀਫਿਕੇਸ਼ਨ ਦੀ ਮਿਆਦ ਖਤਮ',
  ...
  workElsewhere: 'ਕਿਤੇ ਹੋਰ',
  whereQuestion: 'ਕਿਹੜੀ ਜਗ੍ਹਾ?',
  locationSaved: 'ਜਗ੍ਹਾ ਸੇਵ ਹੋ ਗਈ: {place}',
  ...
  otpLengthError: '4 ਅੰਕਾਂ ਦਾ ਕੋਡ ਦਾਖਲ ਕਰੋ',
  otpSentTo: '{phone} ਉੱਤੇ ਕੋਡ ਭੇਜਿਆ',
...
const or: Strings = {
  ...
  applied: 'ଆବେଦନ ହୋଇଛି',
  applying: 'ପଠାଉଛି…',
  loginToApply: 'ପ୍ରଥମେ ଲଗ ଇନ କରନ୍ତୁ',
  loginToApplyBody: 'ଆବେଦନ କରିବାକୁ ଖାତା ଦରକାର, ଯାହାଫଳରେ ନିଯୁକ୍ତିଦାତା ଆପଣଙ୍କୁ ଯୋଗାଯୋଗ କରିପାରିବେ।',
  ...
  optionCertificate: 'ମୋର ବର୍ତ୍ତମାନ ଦକ୍ଷତାର ପ୍ରମାଣପତ୍ର ଦରକାର',
  optionGuidance: 'ମୁଁ ବୁଝିପାରୁନାହିଁ, ପରାମର୍ଶ ଦରକାର',
  ...
  jobPositions: 'ପଦ',
  jobPerMonth: 'ମାସିକ',
  livelihoodMap: 'ଆପଣଙ୍କ ଜୀବିକା ମାନଚିତ୍ର',
  mapJobs: 'ଚାକିରି',
  mapTraining: 'ତାଲିମ',
  mapMatches: 'ମେଳ',
  mapForYou: 'ଆପଣଙ୍କ ପାଇଁ',
  yourSkills: 'ଆପଣଙ୍କ ଦକ୍ଷତା',
  completeProfile: 'ପ୍ରୋଫାଇଲ ପୂର୍ଣ୍ଣ କରନ୍ତୁ',
  recommendedPath: 'ପ୍ରସ୍ତାବିତ ପଥ',
  viewPathway: 'ପଥ ଦେଖନ୍ତୁ',
  potentialRoles: 'ସମ୍ଭାବ୍ୟ ଭୂମିକା',
  noSkillsYet: 'ଦକ୍ଷତା କହିବାକୁ କୁହନ୍ତୁ',
  qualLapsed: 'ପ୍ରମାଣପତ୍ର ମିଆଦ ଶେଷ',
  ...
  workElsewhere: 'ଅନ୍ୟ କେଉଁଠି',
  whereQuestion: 'କେଉଁ ସ୍ଥାନ?',
  locationSaved: 'ସ୍ଥାନ ସେଭ ହେଲା: {place}',
  ...
  otpLengthError: '4 ଅଙ୍କର କୋଡ୍ ଦିଅନ୍ତୁ',
  otpSentTo: '{phone} କୁ କୋଡ୍ ପଠାଗଲା',
